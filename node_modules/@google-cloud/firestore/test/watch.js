...
var Firestore = require('../');
var reference = require('../src/reference')(Firestore);
var DocumentReference = reference.DocumentReference;
var QuerySnapshot = reference.QuerySnapshot;
var DocumentSnapshot = require('../src/document')(
...
const snapshotsEqual = function(version, actual, expected) {
  ...
  for (i = 0; i < expected.docChanges.length; i++) {
    ...
    var readVersion = actual.docChanges[i].type === 'removed' ?
        version - 1: version;
...
const snapshot = function(ref, data) {
  const snapshot = DocumentSnapshot.Builder();
  snapshot.ref = ref;
 ...
 */
function StreamHelper(firestore) {
  this.streamCount = 0;
 ...
 * @private
 */
StreamHelper.prototype.reset_ = function() {
 ...
 */
StreamHelper.prototype.waitForData = function(expectedChunk) {
 ...
 * ends.
 */
StreamHelper.prototype.waitForEnd = function() {
  return this.deferredStream.promise.then((readStream) => {
    return new Promise((resolve, reject) => {
      readStream.once('data', (result) => {
 ...
 * receives an error.
 */
StreamHelper.prototype.waitForError = function() {
  return this.deferredStream.promise.then((readStream) => {
    return new Promise((resolve, reject) => {
      readStream.once('data', (result) => {
 ...
 */
StreamHelper.prototype.write = function(data) {
 ...
 */
StreamHelper.prototype.destroyStream = function() {
 ...
 * @constructor
 */
function WatchHelper(streamHelper, reference, targetId) {
 ...
 * @private
 */
WatchHelper.prototype.reset_ = function() {
...
/**
 * Creates a watch, starts a listen, and asserts that the request got processed.
 * @return A Promise that will be fulfilled when the request has been
 * acknowledged.
 */
WatchHelper.prototype.startWatch = function(requestJSON) {
 ...
 */
WatchHelper.prototype.waitForSnapshot = function() {
 ...
 */
WatchHelper.prototype.endWatch = function() {
  this.unsubscribe();
 ...
 */
WatchHelper.prototype.sendAddTarget =  function() {
 ...
 */
WatchHelper.prototype.sendRemoveTarget = function(cause) {
  const proto = {
    targetChange: {
 ...
 */
WatchHelper.prototype.sendSnapshot = function(version, resumeToken) {
 ...
 */
WatchHelper.prototype.sendCurrent = function(resumeToken) {
  var proto = ({
    targetChange: {
 ...
 */
WatchHelper.prototype.sendDoc = function(ref, data) {
  this.streamHelper.write({
    documentChange: {
      document: {
 ...
 * @param data The data for the doc in proto JSON format.
 */
WatchHelper.prototype.sendDocRemove = function(ref, data) {
  this.streamHelper.write({
    documentChange: {
      document: {
        name: ref.formattedName,
 ...
 * @param ref The document reference.
 */
WatchHelper.prototype.sendDocDelete = function(ref) {
  this.streamHelper.write({
    documentDelete: {
 ...
 */
WatchHelper.prototype.runTest = function(requestJSON, func) {
 ...
 */
WatchHelper.prototype.runFailedTest = function(requestJSON, func,
                                               expectedMessage) {
  var fail = false;
  return this.startWatch(requestJSON).then(() => {
    return func();
...
describe('Query watch', function() {
  ...
  it('without error callback', function(done) {
    var unsubscribe = colRef.onSnapshot(() => {
      unsubscribe();
      done();
    });
  ...
  it('can sort by __name__', function() {
    ...
    var expectedJson = sortedQueryJSON();
