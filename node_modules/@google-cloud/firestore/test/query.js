...
function snapshot(relativePath, data) {
  ...
  var path = Path.fromName(`${databaseRoot}/documents/${relativePath}`);
...
describe('query interface', function() {
  ...
  it('has limit() method', function() {
    var query = firestore.collection('collectionId');
...
describe('select() interface', function() {
  ...
  it('generates proto', function() {
    ...
    var collection = firestore.collection('collectionId');
    var query = collection.select('a', 'b.c');
...
describe('endBefore() interface', function() {
  ...
  it('is immutable', function() {
    var expectedResult = buildQuery(limit(10));
    ...
    var query = firestore.collection('collectionId').limit(10);
    var adjustedQuery = query.orderBy('foo').endBefore({foo: 'foo'});
