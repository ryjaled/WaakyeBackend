...
var DocumentReference = require('../src/reference')(Firestore).
  DocumentReference;
...
describe('Collection interface', function() {
  ...
  it('has doc() method', function() {
    var collectionRef = firestore.collection('colId');
    assert.ok(collectionRef.doc);

    var documentRef = collectionRef.doc('docId');
  ...
  it('has parent() method', function() {
    var collection = firestore.collection('col1/doc/col2');
    assert.equal(collection.path, 'col1/doc/col2');
    var document = collection.parent;
    assert.equal(document.path, 'col1/doc');
  });

  it('supports auto-generated ids', function() {
    var collectionRef = firestore.collection('collectionId');
